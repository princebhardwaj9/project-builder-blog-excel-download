...
public class ExcelFileStorage {
	...
	private void createExcel(Blog blog) throws IOException {
       ...
       // int rowNum = sheet.getLastRowNum();
        int rowNum=0;
        for(@SuppressWarnings("unused") Blog blogpost: list) {
            ...
            dateofpost.setCellValue(blog.getDate().toString());
        ...
        FileOutputStream fileOut = new FileOutputStream("C:\\Users\\hp\\Desktop\\JAVA Lab\\project-builder-blog-excel-download\\blog.xlsx");
	  ...
	  System.out.println("Opening the file"); String excelFilePath ="C:\\Users\\hp\\Desktop\\JAVA Lab\\project-builder-blog-excel-download\\blog.xlsx";
